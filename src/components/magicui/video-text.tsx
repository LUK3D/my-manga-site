...
export function VideoText({
  ...
  return (
    <Component className={cn(`relative size-full`, className)}>
      ...
      <div
        className="absolute inset-0 flex items-center justify-center pointer-none"
        style={{
      ...
      >
        <iframe width="1469" height="691" src="https://www.youtube.com/embed/RBBrZ3d2sJE?autoplay=1&mute=1&t=7&loop=1" title="TVアニメ「鬼滅の刃」ティザーPV" frame-border="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrer-policy="strict-origin-when-cross-origin" allow-fullscreen></iframe>
      </div>
